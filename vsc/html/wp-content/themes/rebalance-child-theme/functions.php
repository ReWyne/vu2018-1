 ...
 */
function orbisius_ct_rebalance_child_theme_child_theme_enqueue_styles() {
    $parent_style = 'orbisius_ct_rebalance_child_theme_parent_style';
    $parent_base_dir = 'rebalance';
...
add_action( 'wp_enqueue_scripts', 'orbisius_ct_rebalance_child_theme_child_theme_enqueue_styles' );
